...
function saveFormData(db, formData) {
  ...
  LEFT JOIN SoloParent ON PersonalInformation.ID = SoloParent.PersonalInfo_ID
  LEFT JOIN SeniorCitizen ON PersonalInformation.ID = SeniorCitizen.PersonalInfo_ID
  LEFT JOIN Osy ON PersonalInformation.ID = Osy.PersonalInfo_ID
  LEFT JOIN Pwd ON PersonalInformation.ID = Pwd.PersonalInfo_ID
  LEFT JOIN Wdc ON PersonalInformation.ID = Wdc.PersonalInfo_ID
  LEFT JOIN Tpm ON PersonalInformation.ID = Tpm.PersonalInfo_ID
  LEFT JOIN FamilyComposition ON PersonalInformation.ID = FamilyComposition.PersonalInfo_ID
`, (err, rows) => {
  if (err) {
      console.error(err.message);
      return;
